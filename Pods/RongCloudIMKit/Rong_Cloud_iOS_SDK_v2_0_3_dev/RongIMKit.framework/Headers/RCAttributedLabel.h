 ...
 *  @return NSDictionary
 */
- (NSDictionary *)highlightedAttributeDictionaryForTextType:
    (NSTextCheckingType)textType;
...
/** 设置高亮显示哪些类型的文本 NSTextCheckingTypeLink |
 * NSTextCheckingTypePhoneNumber */
@property(nonatomic, assign) NSTextCheckingTypes textCheckingTypes;

@property(nonatomic, readonly, assign)
    NSTextCheckingType currentTextCheckingType;
/**
