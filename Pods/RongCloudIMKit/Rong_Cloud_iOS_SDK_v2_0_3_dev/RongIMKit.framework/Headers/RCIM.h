...
@property(nonatomic, weak)
    id<RCIMUserInfoFetcherDelegagte> userInfoFetcherDelegate;
/**
 *  群组信息提供者
 */
@property(nonatomic, weak)
    id<RCIMGroupInfoFetcherDelegate> groupInfoFetcherDelegate;
/**
 *  消息监听
 */
@property(nonatomic, weak)
 ...
 */
@property(nonatomic, weak)
    id<RCIMConnectionStatusDelegate> connectionChangedDelegate;
/**
 *  消息免打扰，默认是NO
 */
 ...
 */
- (void)setConnectionChangedDelegate:
    (id<RCIMConnectionStatusDelegate>)connectionChangedListener;
/**
 设置获取用户信息的获取器，供 RongIM 调用获取群组名称和头像信息。

 @param delegate 用户信息获取器。
 */
- (void)setUserInfoFetcherWithDelegate:
    (id<RCIMUserInfoFetcherDelegagte>)delegate;
 ...
 */
- (void)setGroupInfoFetcherWithDelegate:
    (id<RCIMGroupInfoFetcherDelegate>)delegate;
