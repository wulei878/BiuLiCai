 ...
 */
typedef void (^OnPoiSearchResult)(NSArray *pois, BOOL clearPreviousResult,
...
@interface RCLocationPickerViewController
    : RCBaseViewController <CLLocationManagerDelegate, UITableViewDataSource,
                            UITableViewDelegate>
/**
 *  delegate
 */
 ...
 */
- (void)setMapViewCenter:(CLLocationCoordinate2D)location
...
/**
 ...
 @param animated 是否开启动画效果
 */
- (void)setMapViewCoordinateRegion:(MKCoordinateRegion)coordinateRegion
                          animated:(BOOL)animated;
